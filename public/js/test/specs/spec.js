...
// --------------------------
define(["jquery", "backbone", "underscore","text!templates/main.html","json!data/info.json", 
	"views/View","models/Model", "collections/Collection", "routers/DesktopRouter", "routers/MobileRouter", "jasminejquery"],

    function($, Backbone, _,mainTmpl,info, View, Model, Collection, DesktopRouter, MobileRouter) {

        // Test suite that includes all of the Jasmine unit tests   
        describe("Wedding", function() {

            describe("check json data",function(){
		...
		it("should be an object", function() {
            ...
            describe("Backbone views", function() {
                ...
                it("should contain the appropriate template", function() {
                    ...
                    expect(this.view.template).toEqual(_.template(mainTmpl,info));
...
/*
		//I didn't use backbone validate
